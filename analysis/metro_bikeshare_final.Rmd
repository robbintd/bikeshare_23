...
author: "Thomas Robbins, Eric Fingar"
date: "2023-11-29"
...
Trimming data to fewer points for efficient visualization:
```{r}

# df_bikemetro_dist_clip = df_cleaned_with_distance |> 
...
ggplot(df_bikemetro_dist_clip, aes(x = dist_to_metro, y = total_ridership))+
